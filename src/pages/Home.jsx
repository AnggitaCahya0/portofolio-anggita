import DataImage from "../data/MainData";
import { listTools } from "../data/MainData";
import { listProyek } from "../data/MainData";
  ...
  return (
    <>
      <div className="hero grid md:grid-cols-2 pt-10 items-center xl:gap-0 gap-6 grid-cols-1">
        <div className="animate__animated animate__fadeInUp animate__delay-3s">
          <div className="flex items-center gap-3 mb-6 bg-zinc-800 w-fit p-4 rounded-2xl">
            ...
            />
            <q>Desain bukan hiasan, tetapi jawaban.😊</q>
          </div>
          ...
          <div className="flex items-center sm:gap-4 gap-2">
            <a
              ...
              className="bg-violet-700 p-4 rounded-2xl hover:bg-violet-600 inline-flex items-center gap-2"
            >
              Lihat CV <i className="ri-file-pdf-line ri-lg"></i>
            </a>
      ...
      <div className="proyek mt-32 py-10" id="proyek">
        ...
        <div className="proyek-box mt-10 grid lg:grid-cols-3 sm:grid-cols-2  grid-cols-1 gap-4">
            ...
            >
              ...
              <div>
                ...
                <div className="mt-8 text-center">
                  <Link
                      to={`/case-study/${proyek.slug}`}
                      className="bg-violet-700 p-3 rounded-lg block text-center hover:bg-violet-600"
                    >
                      Lihat Case Study
                    </Link>
                </div>
